...
/// For attributes, methods and constructors, you can use the one of the following:
    ...
    //default:-	The code is only accessible in the same package. This is used when you don't specify a modifier. You will
...
//Non-Access Modifiers
    //Modifier	Description
        //For classes, you can use either final or abstract:
            //final	The class cannot be inherited by other classes (You will learn more about inheritance in the Inheritance
            // chapter)
    ...
    //For attributes and methods, you can use the one of the following:
        ...
        // body, for example abstract void run();. The body is provided by the subclass (inherited from). You will learn more about inheritance and abstraction in the Inheritance and Abstraction chapters
